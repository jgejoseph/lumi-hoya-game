...
class World{
 ...
 if(!this.plane&&!this.bird&&this.time>=(this.nextPlane??300)){this.nextPlane=this.time+55+this.random()*40;this.plane={age:0};this.bird=null;this.endSocial();this.emit('note','抬頭看，一架小飛機經過窗外。');}
 ...
 updateBird(dt){
 if(!this.bird){if(!this.outdoorNight&&!this.night&&this.time>=(this.nextBird??18)){this.bird={phase:'arrive',age:0,id:this.time};}return;}
